    ...
    if konu_adi:
        if islem_modu == "Konu Anlatımı":
            ...
            if konu_icerigi and "Üzgünüm" not in konu_icerigi:
                ...
                if konusma_acik:
                    # JavaScript/HTML injection to enable text-to-speech
...
st.sidebar.markdown(
    ...
    **Yazım Bilgisi** • **Dil Bilgisi** • **Edebi Türler**
    """
)
st.sidebar.caption("Lütfen aradığınız konunun tam adını giriniz. (Örn: 'ek fiil', 'noktalama işaretleri').")
st.sidebar.markdown("---")
